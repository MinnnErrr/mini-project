<div class="col-lg-2 border-end bg-light">
    <div class="offcanvas-lg offcanvas-start position-fixed" tabindex="-1" id="offcanvasResponsive"
        ...
        <div class="offcanvas-body">
            <ul class="nav flex-column d-flex justify-content-between" style="height: 87dvh;">
                ...
                <div  style="bottom: 2px; width: 200px;" class=" position-absolute bottom-0 start-0">
                    <li class="nav-item">
                        <div class="nav-link">
